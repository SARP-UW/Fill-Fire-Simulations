...
P_bottle(1) = get_state_variable(T_bottle(1), x_bottle(1), "Pressure_Mpa");
...
P_run_tank(1) = get_state_variable(T_run_tank(1), x_run_tank(1), "Pressure_Mpa");
v_run_tank(1) = get_state_variable(T_bottle(1), x_run_tank(1), "Volume_m3_kg");
...
for n = 2:length(t)-1
    ...
    h_g_run_tank(n) = get_state_variable(T_run_tank(n), "g", "Enthalpy_kJ__kg");
